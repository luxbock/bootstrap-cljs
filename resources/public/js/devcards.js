...
document.write('<script>if (typeof goog != "undefined") { goog.require("bootstrap_cljs_devcards"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');